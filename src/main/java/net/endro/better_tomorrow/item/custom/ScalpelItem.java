package net.endro.better_tomorrow.item.custom;
...
public class ScalpelItem extends Item {
    private static final Map<Block, Block> SCALPEL_MAP =
            Map.of(
                    ...
                    Blocks.NETHERRACK, ModBlocks.ENRICHIUM_BLOCK.get()
            );
    ...
    public InteractionResult useOn(UseOnContext context) {
        ...
        if(SCALPEL_MAP.containsKey(clickedBlock)) {
            if(!level.isClientSide()) {
                level.setBlockAndUpdate(context.getClickedPos(), SCALPEL_MAP.get(clickedBlock).defaultBlockState());
